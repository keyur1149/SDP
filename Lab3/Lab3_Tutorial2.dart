...
//MiniExercise
  ...
  // }
  // var call = youAreWonderful("Keyur",5);
  // print(call);
  ///
  ///
  ///3
  ...
  //   return ("You're wonderful, $name.$numberPeople think so.");
  // }
  // var call = youAreWonderful(name:"Keyur",numberPeople : 5);
  // print(call);
  // var call2 = youAreWonderful(name:"Keyur");
  // print(call2);
  ...
  var call3 = wonderful(name: "Keyur", numberPeople: 5);
  print(call3);
