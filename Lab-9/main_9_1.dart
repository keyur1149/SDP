...
//           children: [
//             CircleAvatar(
//               backgroundImage: AssetImage('assets/sub_assets/keyur.jpeg'),
//             ),
//             Text(
//               'NAME: ',
//               style: TextStyle(
...
// */
//   List<Quote> quotes = [
//     Quote(text: 'The truth is realy pure and never simple',author:  'Keyur Jivani'),
//     Quote(author: 'Keyur', text: 'I see humans but no humanity'),  Quote(text: 'The time is always right to do what is right',author:  'Keyur1'),
//   ]
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
*/
  List<Quote> quotes = [
    Quote(text: 'The truth is that hardship pays', author: 'Keyur Jivani'),
    Quote(author: 'Keyur', text: 'I see humans with fame of humanity'),
    Quote(
